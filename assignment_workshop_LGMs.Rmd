...
```{r warning=FALSE, class.source="fold-show", getpackages, message=FALSE}
...
path <- "C:/Users/leamic/Desktop/" #change to your folder

setwd(path)
wisc <- read.csv("C:/Users/leamic/Desktop/LGC_Workshop/wisc.csv")[,-1]
...
**Assignment 26: Perform the same steps as in assignments 7, 8 and 14 but take into account the uneven time intervals in your loadings. Compare the three fit of the three models. do you have the same result as in the previous assignments?**
...
**Assignment 28: Within that model, explore how baseline level of one metric predict the changes in the other. How do the predict each other? **
...
**Assignment 29: Simulate a linear growth model with 4 waves. The intercepts should have a mean of 100 and a variance of 15. The slope should have a mean of 5 and a variance of 10. The intercept-slope covariance should have a mean of 3.**
...
**Assignment 30: Simulate a linear growth model with three groups.**
...
**Assignment 31: Use the previous simulate data model to test the effect size of a predictor on the slope. **
